...
function DrawInfo(){
  if (ShowInfo){
    ...
    const Information = `
      ...
      More detailed information you'll be able to see at my website soon (at least I hope so...)
...
function SetUpUI(){
  ...
  else InterfaceSwitcher.size(displayWidth / 3.5, 45);
  ...
  if (Device == "Laptop"){
    ...
    KillAllButton.position((windowWidth - 5) / 2 - 75, 10);
     ...
     KillAllButton.size(displayWidth / 3.5, 45);
  ...
  if (Device == "Laptop"){
    ...
    MakeBalancedSetButton.position((windowWidth - 5) / 2 - 87.5, 10);
     ...
     MakeBalancedSetButton.size(displayWidth / 3.5, 45);
     MakeBalancedSetButton.position((windowWidth - 5) / 2 - (displayWidth / 3 / 2), 10);
  }
  ...
  if (Device == "Laptop"){
    ...
    MakeRandomSetButton.position((windowWidth - 5) / 2 - 87.5, 50);
     ...
     MakeRandomSetButton.size(displayWidth / 3.5, 45);
     MakeRandomSetButton.position((windowWidth - 5) / 2 - (displayWidth / 3.5 / 2), 75);
  }
  ...
  if (Device == "Laptop"){
    ...
    StatsSwitcherButton.position(windowWidth - 165, 10);
     ...
     StatsSwitcherButton.size(displayWidth / 3.5, 45);
  ...
  if (Device == "Laptop"){
    ...
    if (Device == "Laptop"){
      ...
      InfoButton.position(windowWidth - 115, windowHeight - 45);
       ...
       InfoButton.size(displayWidth / 4, 45);
       InfoButton.position(windowWidth - displayWidth / 4 - 15, windowHeight - 75);
    }
  ...
  if (Device == "Laptop"){
    ...
    ChangeCreatureButton.position((windowWidth - 5) / 2 - 80, windowHeight - 45);
     ...
     ChangeCreatureButton.size(displayWidth / 3.5, 45);
     ChangeCreatureButton.position((windowWidth - 5) / 2 - (displayWidth / 3.5 / 2), windowHeight - 75);
  }
  ...
  if (Device == "Laptop"){
    ...
    DieButton.position((windowWidth - 5) / 2 + 40, windowHeight - 270);
    DieButton.size(displayWidth / 3.5, 45);
  }
  ...
  if (Device == "Laptop"){
    ...
    MakeChildrenButton.position((windowWidth - 5) / 2 + 40, windowHeight - 213);
    MakeChildrenButton.size(displayWidth / 3.5, 45);
  }
...
function setup() {
  ...
  if (Device == "Laptop") createCanvas(windowWidth - 5, windowHeight - 5);
...
function draw() {
  ...
  if (Device != "Laptop") text("v.1.3", windowWidth - 40, windowHeight - 20);
