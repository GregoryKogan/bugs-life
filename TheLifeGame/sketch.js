...
function SetUpUI(){
  ...
  if (Device == "Laptop"){
    ...
    if (Device == "Laptop"){
      ...
      InfoButton.position(windowWidth - 115, windowHeight - 45);
       ...
       InfoButton.size(displayWidth / 4, 30);
       InfoButton.position(windowWidth - displayWidth / 4 - 15, windowHeight - 45);
    }
  ...
  if (Device == "Laptop"){
    ...
    ChangeCreatureButton.position((windowWidth - 5) / 2 - 80, windowHeight - 45);
     ...
     ChangeCreatureButton.position((windowWidth - 5) / 2 - (displayWidth / 3.5 / 2), windowHeight - 45);
  }
