...
function SetUpUI(){
  ...
  InterfaceSwitcher = createButton("Hide UI");
  InterfaceSwitcher.position(10, 10);
  InterfaceSwitcher.size(150, 30);
  ...
  KillAllButton = createButton("Kill Them All!");
  ...
  MakeBalancedSetButton = createButton("Make Balanced Set");
  ...
  MakeRandomSetButton = createButton("Make Random Set");
  ...
  StatsSwitcherButton = createButton("Hide Stats");
  ...
  InfoButton.position(windowWidth - 165, windowHeight - 45);
  ...
  ChangeCreatureButton = createButton("Change Creature");
  ...
  MakeChildrenButton = createButton("Make Chidren");
  ...
  ApplyChangesButton = createButton("Apply Changes");
  ...
  CreatureFoodPrefsSelector.position((windowWidth - 5) / 2 - 190, windowHeight - 210);
  ...
  CreatureLazinessCheckBox.position((windowWidth - 5) / 2 - 190, windowHeight - 280);
  ...
  CreatureBraveryCheckBox.position((windowWidth - 5) / 2 - 190, windowHeight - 250);
...
function SwitchStats(){
  if (ShowStatistics == true){
    ...
    ShowStatistics = !ShowStatistics;
    StatsSwitcherButton.html("Hide Stats");
  }
}
